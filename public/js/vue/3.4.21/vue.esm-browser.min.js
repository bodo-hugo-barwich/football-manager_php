...
const EMPTY_OBJ = Object.freeze({}),
  ...
  isPromise = (e) =>
    (isObject(e) || isFunction(e)) && isFunction(e.then) && isFunction(e.catch),
  ...
  toHandlerKey = cacheStringFunction((e) => {
    return e ? "on" + capitalize(e) : "";
  }),
...
function normalizeStyle(t) {
  ...
  if (isString(t) || isObject(t)) return t;
}
...
function stringifyStyle(e) {
  let t = "";
  if (!e || isString(e)) return t;
  for (const o in e) {
    var n = e[o],
      r = o.startsWith("--") ? o : hyphenate(o);
    (!isString(n) && "number" != typeof n) || (t += r + `:${n};`);
  }
  return t;
}
      ...
      : isMap(t)
        ? {
            [`Map(${t.size})`]: [...t.entries()].reduce(
              (e, [t, n], r) => ((e[stringifySymbol(t, r) + " =>"] = n), e),
              {},
            ),
          }
        : isSet(t)
  ...
  get dirty() {
    if (2 === this._dirtyLevel || 3 === this._dirtyLevel) {
      ...
      for (let e = 0; e < this._depsLength; e++) {
        var t = this.deps[e];
        if (t.computed && (triggerComputed(t.computed), 4 <= this._dirtyLevel))
          break;
      }
...
function resetScheduling() {
  for (
    pauseScheduleStack--;
    !pauseScheduleStack && queueEffectSchedulers.length;
...
function trackEffect(e, t, n) {
  ...
  t.get(e) !== e._trackId &&
    ...
    (r = e.deps[e._depsLength]) !== t
      ? (r && cleanupDepEffect(r, e), (e.deps[e._depsLength++] = t))
      : e._depsLength++,
    null != (r = e.onTrack) && r.call(e, extend({ effect: e }, n)));
}
const queueEffectSchedulers = [];
function triggerEffects(t, n, r) {
  var o;
  pauseScheduling();
  for (const s of t.keys()) {
    let e;
    s._dirtyLevel < n &&
      (null != e ? e : (e = t.get(s) === s._trackId)) &&
      (s._shouldSchedule || (s._shouldSchedule = 0 === s._dirtyLevel),
      (s._dirtyLevel = n)),
      s._shouldSchedule &&
        (null != e ? e : (e = t.get(s) === s._trackId)) &&
        (null != (o = s.onTrigger) && o.call(s, extend({ effect: s }, r)),
        s.trigger(),
        (s._runnings && !s.allowRecurse) ||
          2 === s._dirtyLevel ||
          ((s._shouldSchedule = !1),
          s.scheduler && queueEffectSchedulers.push(s.scheduler)));
  }
  resetScheduling();
}
const createDep = (e, t) => {
...
function track(n, r, o) {
  if (shouldTrack && activeEffect) {
    ...
    t || e.set(o, (t = createDep(() => e.delete(o)))),
      trackEffect(activeEffect, t, { target: n, type: r, key: o });
  }
}
function trigger(e, t, r, o, s, i) {
  ...
  if (a) {
    ...
    if ("clear" === t) n = [...a.values()];
      ...
      const l = Number(o);
      a.forEach((e, t) => {
        ("length" === t || (!isSymbol(t) && t >= l)) && n.push(e);
      });
    } else
  ...
  return (
    ...
    ["push", "pop", "shift", "unshift", "splice"].forEach((t) => {
      e[t] = function (...e) {
        ...
        return resetScheduling(), resetTracking(), e;
      };
    }),
    e
  );
...
class BaseReactiveHandler {
  ...
  get(e, t, n) {
    ...
    var s = isArray(e);
    if (!r) {
      if (s && hasOwn(arrayInstrumentations, t))
...
class MutableReactiveHandler extends BaseReactiveHandler {
  ...
  ownKeys(e) {
    return (
      track(e, "iterate", isArray(e) ? "length" : ITERATE_KEY),
      Reflect.ownKeys(e)
    );
  }
}
...
function get(e, t, n = !1, r = !1) {
  var o = toRaw((e = e.__v_raw)),
    s = toRaw(t);
  n || (hasChanged(t, s) && track(o, "get", t), track(o, "get", s));
...
function has(e, t = !1) {
  ...
  var r = toRaw(n),
    o = toRaw(e);
  return (
    t || (hasChanged(e, o) && track(r, "has", e), track(r, "has", o)),
...
function checkIdentityKeys(e, t, n) {
  ...
  r !== n &&
    t.call(e, r) &&
    warn$2(
      `Reactive ${(n = toRawType(e))} contains both the raw and reactive versions of the same object${"Map" === n ? " as keys" : ""}, which can lead to inconsistencies. Avoid differentiating between the raw and reactive versions of an object and only use the reactive version if possible.`,
    );
}
...
function createReactiveObject(e, t, n, r, o) {
  if (!isObject(e))
    return warn$2("value cannot be made reactive: " + String(e)), e;
  ...
  constructor(e, t, n, r) {
    (this.getter = e),
      ...
      (this.effect = new ReactiveEffect(
        () => e(this._value),
        () => triggerRefValue(this, 2 === this.effect._dirtyLevel ? 2 : 3),
      )),
  ...
  get value() {
    ...
    return (
      (e._cacheable && !e.effect.dirty) ||
        !hasChanged(e._value, (e._value = e.effect.run())) ||
        triggerRefValue(e, 4),
      trackRefValue(e),
...
function triggerRefValue(e, t = 4, n) {
  var r = (e = toRaw(e)).dep;
  r &&
    triggerEffects(r, t, { target: e, type: "set", key: "value", newValue: n });
}
function isRef(e) {
  ...
  set value(e) {
    ...
    (e = t ? e : toRaw(e)),
      hasChanged(e, this._rawValue) &&
        ((this._rawValue = e),
        (this._value = t ? e : toReactive(e)),
        triggerRefValue(this, 4, e));
  }
}
function triggerRef(e) {
  triggerRefValue(e, 4, e.value);
}
function unref(e) {
...
function warn$1(e, ...t) {
  pauseTracking();
  const n = stack$1.length ? stack$1[stack$1.length - 1].component : null;
...
function assertNumber(e, t) {
  void 0 !== e &&
    ("number" != typeof e
      ? warn$1(`${t} is not a valid number - got ${JSON.stringify(e)}.`)
      : isNaN(e) &&
        warn$1(t + " is NaN - the duration expression might be incorrect."));
}
const ErrorCodes = {
    SETUP_FUNCTION: 0,
    0: "SETUP_FUNCTION",
...
function handleError(t, n, r, e = !0) {
  ...
  if (n) {
    let e = n.parent;
    for (var s = n.proxy, i = ErrorTypeStrings$1[r]; e; ) {
      const a = e.ec;
      if (a)
...
function flushPreFlushCbs(e, t, n = isFlushing ? flushIndex + 1 : 0) {
  for (t = t || new Map(); n < queue.length; n++) {
    const r = queue[n];
    r &&
      r.pre &&
      ((e && r.id !== e.uid) ||
        checkRecursiveUpdates(t, r) ||
        (queue.splice(n, 1), n--, r()));
  }
}
function flushPostFlushCbs(e) {
  if (pendingPostFlushCbs.length) {
    var t = [...new Set(pendingPostFlushCbs)].sort(
      (e, t) => getId(e) - getId(t),
    );
    if (((pendingPostFlushCbs.length = 0), activePostFlushCbs))
      ...
      for (
        activePostFlushCbs = t, e = e || new Map(), postFlushIndex = 0;
    ...
    for (const s of o) {
      ...
      hmrDirtyComponents.has(r) ||
        ...
        s.ceReload
          ...
          : s.parent
            ? ((s.parent.effect.dirty = !0), queueJob(s.parent.update))
            : s.appContext.reload
              ? s.appContext.reload()
              : "undefined" != typeof window
...
function emit(r, o, ...s) {
  if (!r.isUnmounted) {
    ...
    if (a)
      if (o in a) {
        ...
        (l && toHandlerKey(o) in l) ||
          warn$1(
            `Component emitted event "${o}" but it is neither declared in the emits option nor as an "${toHandlerKey(o)}" prop.`,
          );
    let e = s;
    ...
    c !== o &&
      i[toHandlerKey(c)] &&
      warn$1(
        `Event "${c}" is emitted in component ${formatComponentName(r, r.type)} but the handler is registered for "${o}". Note that HTML attributes are case-insensitive and you cannot use v-on to listen to camelCase events when using in-DOM templates. You should probably use "${hyphenate(o)}" instead of "${o}".`,
      );
    let t,
...
function renderComponentRoot(t) {
    ...
    if (4 & n.shapeFlag) {
      var S = o || r,
        E = h.__isScriptSetup
          ...
          : S;
      (g = normalizeVNode(p.call(E, S, d, s, h, u, f))), (v = l);
    } else {
      const x = e;
  ...
  let C = g,
    b = void 0;
  if (
    (0 < g.patchFlag && 2048 & g.patchFlag && ([C, b] = getChildRoot(g)),
    v && !1 !== m)
  ) {
    ...
    if (_.length)
      if (7 & E)
        i && _.some(isModelListener) && (v = filterModelListeners(v, i)),
          (C = cloneVNode(C, v));
        ...
        for (let e = 0, t = T.length; e < t; e++) {
          const O = T[e];
          isOn(O)
            ? isModelListener(O) || R.push(O[2].toLowerCase() + O.slice(3))
            : w.push(O);
        }
        w.length &&
          warn$1(
...
const getChildRoot = (t) => {
  const n = t.children,
    r = t.dynamicChildren;
  var e = filterSingleRoot(n, !1);
  if (!e) return [t, void 0];
  if (0 < e.patchFlag && 2048 & e.patchFlag) return getChildRoot(e);
  const o = n.indexOf(e),
    s = r ? r.indexOf(e) : -1;
  return [
    normalizeVNode(e),
...
function filterSingleRoot(t, n = !0) {
  let r;
  for (let e = 0; e < t.length; e++) {
    var o = t[e];
    if (!isVNode(o)) return;
    if (o.type !== Comment || "v-if" === o.children) {
      ...
      if (((r = o), n && 0 < r.patchFlag && 2048 & r.patchFlag))
        return filterSingleRoot(r.children);
    }
  }
  return r;
}
...
If this is a native custom element, make sure to exclude it from component resolution via compilerOptions.isCustomElement.`
  ...
  warn$1(
    `resolve${capitalize(e.slice(0, -1))} can only be used in render() or setup().`,
  );
}
...
const SuspenseImpl = {
    ...
    process(e, t, n, r, o, s, i, a, l, c) {
      if (null == e) mountSuspense(t, n, r, o, s, i, a, l, c);
      else {
...
function mountSuspense(e, t, n, r, o, s, i, a, l) {
  ...
  var d = p("div");
  const u = (e.suspense = createSuspenseBoundary(e, o, r, t, d, n, s, i, a, l));
  c(null, (u.pendingBranch = e.ssContent), d, null, r, u, s, i),
    0 < u.deps
      ? (triggerEvent(e, "onPending"),
        triggerEvent(e, "onFallback"),
        c(null, e.ssFallback, t, n, r, null, s, i),
        setActiveBranch(u, e.ssFallback))
      : u.resolve(!1, !0);
}
function patchSuspense(
  ...
  if (f)
    isSameVNodeType((d.pendingBranch = e), f)
      ? (l(f, e, d.hiddenContainer, null, o, d, s, i, a),
        d.deps <= 0
          ? d.resolve()
          : m && !g && (l(h, u, n, r, o, null, s, i, a), setActiveBranch(d, u)))
      : ((d.pendingId = suspenseId++),
        g ? ((d.isHydrating = !1), (d.activeBranch = f)) : c(f, o, d),
        (d.deps = 0),
        (d.effects.length = 0),
        (d.hiddenContainer = p("div")),
        m
          ? (l(null, e, d.hiddenContainer, null, o, d, s, i, a),
            d.deps <= 0
              ? d.resolve()
              : (l(h, u, n, r, o, null, s, i, a), setActiveBranch(d, u)))
          : h && isSameVNodeType(e, h)
            ? (l(h, e, n, r, o, d, s, i, a), d.resolve(!0))
            : (l(null, e, d.hiddenContainer, null, o, d, s, i, a),
              d.deps <= 0 && d.resolve()));
  else if (h && isSameVNodeType(e, h))
    l(h, e, n, r, o, d, s, i, a), setActiveBranch(d, e);
  else if (
    (triggerEvent(t, "onPending"),
    512 & (d.pendingBranch = e).shapeFlag
      ? (d.pendingId = e.component.suspenseId)
      : (d.pendingId = suspenseId++),
    l(null, e, d.hiddenContainer, null, o, d, s, i, a),
    d.deps <= 0)
  )
    ...
    const { timeout: v, pendingId: y } = d;
    0 < v
      ? setTimeout(() => {
          d.pendingId === y && d.fallback(u);
        }, v)
      : 0 === v && d.fallback(u);
  }
}
let hasWarned = !1;
function createSuspenseBoundary(e, u, n, t, r, h, i, c, p, o, s = !1) {
  hasWarned ||
    ((hasWarned = !0),
  ...
  const {
    ...
    um: m,
    n: g,
    o: { parentNode: v, remove: a },
  } = o;
  let y;
  const S = isVNodeSuspensible(e);
  S && null != u && u.pendingBranch && ((y = u.pendingId), u.deps++);
  o = e.props ? toNumber(e.props.timeout) : void 0;
  assertNumber(o, "Suspense timeout");
  const E = h,
    C = {
      vnode: e,
      parent: u,
      ...
      resolve(e = !1, t = !1) {
              ...
              : e ||
                ((c = r && o.transition && "out-in" === o.transition.mode) &&
                  (r.transition.afterLeave = () => {
                    s === C.pendingId &&
                      (f(o, l, h === E ? g(r) : h, 0), queuePostFlushCb(i));
                  }),
                r &&
                  (v(r.el) !== C.hiddenContainer && (h = g(r)), m(r, a, C, !0)),
                c || f(o, l, h, 0)),
            setActiveBranch(C, o),
        ...
        for (; p; ) {
          if (p.pendingBranch) {
            p.effects.push(...i), (d = !0);
            break;
          }
          p = p.parent;
        }
        d || c || queuePostFlushCb(i),
          (C.effects = []),
          S &&
            u &&
            u.pendingBranch &&
            y === u.pendingId &&
            (u.deps--, 0 !== u.deps || t || u.resolve()),
          triggerEvent(n, "onResolve");
      },
      fallback(e) {
        if (C.pendingBranch) {
          const {
            ...
            l = (triggerEvent(r, "onFallback"), g(o));
          var t = () => {
              C.isInFallback &&
                (d(null, e, i, l, s, null, a, c, p), setActiveBranch(C, e));
            },
        ...
        n.asyncDep
          ...
          .then((e) => {
            if (
              ...
              n.asyncResolved = !0;
              const t = n["vnode"];
              pushWarningContext(t),
                handleSetupResult(n, e, !1),
                s && (t.el = s);
              e = !s && n.subTree.el;
              r(n, t, v(s || n.subTree.el), s ? null : g(n.subTree), C, i, p),
                e && a(e),
...
function hydrateSuspense(e, t, n, r, o, s, i, a, l) {
  ...
  return 0 === c.deps && c.resolve(!1, !0), r;
}
  ...
  return (
    ...
    isArray(t) &&
      (!(n = filterSingleRoot(t)) &&
        0 < t.filter((e) => e !== NULL_DYNAMIC_COMPONENT).length &&
...
function setActiveBranch(e, t) {
  ...
  (n.el = o), r && r.subTree === n && ((r.vnode.el = o), updateHOCHostEl(r, o));
}
...
function watchPostEffect(e, t) {
  return doWatch(e, null, extend({}, t, { flush: "post" }));
}
function watchSyncEffect(e, t) {
  return doWatch(e, null, extend({}, t, { flush: "sync" }));
}
...
function doWatch(
  ...
  const l = (e) => {
    ...
    c = currentInstance,
    p = (e) => (!0 === r ? e : traverse(e, !1 === r ? 1 : void 0));
  let d,
    u = !1,
    h = !1;
  if (
    (isRef(e)
      ? ((d = () => e.value), (u = isShallow(e)))
      : isReactive(e)
        ? ((d = () => p(e)), (u = !0))
        : isArray(e)
          ? ((h = !0),
              ...
              e.map((e) =>
                isRef(e)
                  ...
                  : isReactive(e)
                    ? p(e)
                    : isFunction(e)
                      ? callWithErrorHandling(e, c, 2)
                      : void l(e),
              )))
          : isFunction(e)
            ? (d = t
                ? () => callWithErrorHandling(e, c, 2)
                : () => (f && f(), callWithAsyncErrorHandling(e, c, 3, [m])))
            : ((d = NOOP), l(e)),
    t && r)
  ) {
    const T = d;
  ...
  let f,
    m = (e) => {
      f = S.onStop = () => {
        callWithErrorHandling(e, c, 4), (f = S.onStop = void 0);
      };
    },
    g = h
  ...
  const v = () => {
    if (S.active && S.dirty)
      if (t) {
        ...
        (r ||
          u ||
          (h ? e.some((e, t) => hasChanged(e, g[t])) : hasChanged(e, g))) &&
          (f && f(),
          callWithAsyncErrorHandling(t, c, 3, [
            e,
            g === INITIAL_WATCHER_VALUE
              ? void 0
              : h && g[0] === INITIAL_WATCHER_VALUE
                ? []
                : g,
            m,
          ]),
  ...
  y =
    "sync" === o
      ? v
      : "post" === o
        ? () => queuePostRenderEffect(v, c && c.suspense)
        : ((v.pre = !0), c && (v.id = c.uid), () => queueJob(v));
  const S = new ReactiveEffect(d, NOOP, y),
    E = getCurrentScope(),
    C = () => {
      S.stop(), E && remove(E.effects, S);
    };
  return (
    (S.onTrack = i),
    (S.onTrigger = a),
    t
      ? n
        ...
        : (g = S.run())
      : "post" === o
        ? queuePostRenderEffect(S.run.bind(S), c && c.suspense)
        : S.run(),
    C
  );
}
function instanceWatch(e, t, n) {
  ...
  const i = setCurrentInstance(this);
  t = doWatch(o, s.bind(r), n);
  return i(), t;
}
...
function traverse(t, n, r = 0, o) {
  if (!isObject(t) || t.__v_skip) return t;
  if (n && 0 < n) {
    if (n <= r) return t;
    r++;
  }
  if ((o = o || new Set()).has(t)) return t;
  if ((o.add(t), isRef(t))) traverse(t.value, n, r, o);
  else if (isArray(t))
    for (let e = 0; e < t.length; e++) traverse(t[e], n, r, o);
  else if (isSet(t) || isMap(t))
    t.forEach((e) => {
      traverse(e, n, r, o);
    });
  else if (isPlainObject(t)) for (const e in t) traverse(t[e], n, r, o);
  return t;
}
...
const TransitionHookValidator = [Function, Array],
  ...
  BaseTransitionImpl = {
    ...
    setup(c, { slots: t }) {
      ...
      return () => {
        var n = t.default && getTransitionRawChildren(t.default(), !0);
        if (n && n.length) {
          let t = n[0];
          if (1 < n.length) {
            let e = !1;
          ...
          if (
            (e &&
              ...
              "out-in" !== e &&
              "default" !== e &&
              warn$1("invalid <transition> mode: " + e),
            d.isLeaving)
          )
            return emptyPlaceholder(t);
          var r = getKeepAliveChild(t);
          if (!r) return emptyPlaceholder(t);
          const s = resolveTransitionHooks(r, n, d, p);
          setTransitionHooks(r, s);
          var o = p.subTree;
          const i = o && getKeepAliveChild(o);
          if (i && i.type !== Comment && !isSameVNodeType(r, i)) {
            const l = resolveTransitionHooks(i, n, d, p);
            if ((setTransitionHooks(i, l), "out-in" === e))
              return (
                (d.isLeaving = !0),
                (l.afterLeave = () => {
                  (d.isLeaving = !1) !== p.update.active &&
                    ((p.effect.dirty = !0), p.update());
                }),
                emptyPlaceholder(t)
              );
            "in-out" === e &&
              r.type !== Comment &&
              (l.delayLeave = (e, t, n) => {
                const r = getLeavingNodesForType(d, i);
                (r[String(i.key)] = i),
                  (e[leaveCbKey] = () => {
                    t(), (e[leaveCbKey] = void 0), delete s.delayedLeave;
                  }),
                  (s.delayedLeave = n);
              });
          }
  ...
  const {
    ...
    T = {
      ...
      beforeEnter(e) {
        ...
        const n = E[S];
        n && isSameVNodeType(s, n) && n.el[leaveCbKey] && n.el[leaveCbKey](),
          C(t, [e]);
      },
      enter(t) {
        let e = l,
        ...
        let o = !1;
        var s = (t[enterCbKey$1] = (e) => {
          o ||
            ((o = !0),
            e ? C(r, [t]) : C(n, [t]),
            T.delayedLeave && T.delayedLeave(),
            (t[enterCbKey$1] = void 0));
        });
        e ? b(e, [t, s]) : s();
      },
      leave(t, n) {
        const r = String(s.key);
        if ((t[enterCbKey$1] && t[enterCbKey$1](!0), i.isUnmounting))
          return n();
        C(d, [t]);
        let o = !1;
        var e = (t[leaveCbKey] = (e) => {
          o ||
            ((o = !0),
            n(),
            e ? C(f, [t]) : C(h, [t]),
          ...
          .then(() => {
            (r.value = !0),
              t.parent &&
                ...
                ((t.parent.effect.dirty = !0), queueJob(t.parent.update));
          })
          .catch((e) => {
            n(e), (o.value = e);
          }),
  ...
  KeepAliveImpl = {
    ...
    setup(a, { slots: l }) {
      ...
      (e.activate = (t, e, n, r, o) => {
        const s = t.component;
        h(t, e, n, 0, i),
          u(s.vnode, t, e, n, s, i, r, t.slotScopeIds, o),
        ...
        watch(
          () => [a.include, a.exclude],
          ([t, n]) => {
            t && f((e) => matches(t, e)), n && f((e) => !matches(n, e));
          },
          { flush: "post", deep: !0 },
        );
      let g = null;
          ...
          return (
            ...
            s
              ? ((n.el = s.el),
                ...
                p.add(o))
              : (p.add(o),
                i && p.size > parseInt(i, 10) && m(p.values().next().value)),
            (n.shapeFlag |= 256),
            (d = n),
...
function injectHook(n, r, o = currentInstance, e = !1) {
  if (o) {
    const s = o[n] || (o[n] = []);
    var t =
      r.__weh ||
      (r.__weh = (...e) => {
        if (!o.isUnmounted) {
          pauseTracking();
          const t = setCurrentInstance(o);
          e = callWithAsyncErrorHandling(r, o, n, e);
          return t(), resetTracking(), e;
        }
      });
    return e ? s.unshift(t) : s.push(t), t;
  }
  warn$1(
    toHandlerKey(ErrorTypeStrings$1[n].replace(/ hook$/, "")) +
...
const getPublicInstance = (e) =>
  ...
  PublicInstanceProxyHandlers = {
    get({ _: e }, t) {
      ...
      return p
        ? ("$attrs" === t
            ? (track(e, "get", t), markAttrsAccessed())
            : "$slots" === t && track(e, "get", t),
          p(e))
        : (d = a.__cssModules) && (d = d[t])
          ? d
          : n !== EMPTY_OBJ && hasOwn(n, t)
            ? ((i[t] = 4), n[t])
            : ((u = l.config.globalProperties),
              hasOwn(u, t)
                ? u[t]
                : void (
  ...
  RuntimeCompiledPublicInstanceProxyHandlers = extend(
    ...
    PublicInstanceProxyHandlers,
    {
      ...
      has(e, t) {
        var n = "_" !== t[0] && !isGloballyAllowed(t);
        return (
          !n &&
...
function defineSlots() {
  return warnRuntimeUsage("defineSlots"), null;
}
...
function applyOptions(e) {
  ...
  if (t) for (const _ in t) b("Props", _);
  if ((c && resolveInjections(c, r, b), i))
    for (const R in i) {
      const w = i[R];
      isFunction(w)
        ? (Object.defineProperty(r, R, {
          ...
          b("Methods", R))
        : warn$1(
            `Method "${R}" has type "${typeof w}" in the component definition. Did you reference the function correctly?`,
          );
    }
  if (o) {
    isFunction(o) ||
    ...
    for (const k in s) {
      ...
      var T = isFunction(N)
          ...
          : isFunction(N.get)
            ...
            : NOOP,
        j =
          (T === NOOP && warn$1(`Computed property "${k}" has no getter.`),
          !isFunction(N) && isFunction(N.set)
            ? N.set.bind(n)
            : () => {
                warn$1(
...
function resolveInjections(e, n, r = NOOP) {
  for (const s in (e = isArray(e) ? normalizeInject(e) : e)) {
    var o = e[s];
    let t;
    isRef(
      (t = isObject(o)
        ? "default" in o
          ? inject(o.from || s, o.default, !0)
          : inject(o.from || s)
        : inject(o)),
    )
  ...
  if (o || currentApp)
    return (r = o
      ? null == o.parent
        ...
        : o.parent.provides
      : currentApp._context.provides) && e in r
      ? r[e]
      : 1 < arguments.length
        ? n && isFunction(t)
          ? t.call(o && o.proxy)
...
function updateProps(t, n, r, e) {
  ...
  if (isInHmrContext(t) || !(e || 0 < i) || 16 & i) {
    ...
    let e;
    for (const h in a)
      (n && (hasOwn(n, h) || ((e = hyphenate(h)) !== h && hasOwn(n, e)))) ||
        (l
          ? !r ||
            (void 0 === r[h] && void 0 === r[e]) ||
            (o[h] = resolvePropValue(l, a, h, void 0, t, !0))
          : delete o[h]);
    if (s !== a)
      for (const f in s) (n && hasOwn(n, f)) || (delete s[f], (c = !0));
  } else if (8 & i) {
    var p = t.vnode.dynamicProps;
    for (let e = 0; e < p.length; e++) {
      var d,
        u = p[e];
      isEmitListener(t.emitsOptions, u) ||
        ((d = n[u]),
        !l || hasOwn(s, u)
          ? d !== s[u] && ((s[u] = d), (c = !0))
...
function setFullProps(t, n, r, o) {
  ...
  if (i) {
    ...
    for (let e = 0; e < i.length; e++) {
      var h = i[e];
      r[h] = resolvePropValue(s, d, h, u[h], t, !hasOwn(u, h));
    }
  }
  return a;
}
function resolvePropValue(e, t, n, r, o, s) {
  ...
  if (null != e) {
    ...
    if (i && void 0 === r) {
      const a = e.default;
      if (e.type !== Function && !e.skipFactory && isFunction(a)) {
    ...
    for (const h in s) {
      ...
      if (validatePropName(p)) {
        var d,
          u = s[h];
        const f = (i[p] =
          isArray(u) || isFunction(u) ? { type: u } : extend({}, u));
        f &&
          ((u = getTypeIndex(Boolean, f.type)),
          (d = getTypeIndex(String, f.type)),
          (f[0] = -1 < u),
          (f[1] = d < 0 || u < d),
          (-1 < u || hasOwn(f, "default")) && a.push(p));
      }
    }
  }
  t = [i, a];
  ...
  for (const i in o) {
    ...
    null != s &&
      validateProp(
        ...
        s,
        shallowReadonly(r),
        !hasOwn(e, i) && !hasOwn(e, hyphenate(i)),
      );
  }
}
function validateProp(e, n, t, r, o) {
  const { type: s, required: i, validator: a, skipCheck: l } = t;
  if (i && o) warn$1('Missing required prop: "' + e + '"');
  else if (null != n || i) {
    if (null != s && !0 !== s && !l) {
      let t = !1;
      var c = isArray(s) ? s : [s];
      ...
      for (let e = 0; e < c.length && !t; e++) {
        var { valid: p, expectedType: d } = assertType(n, c[e]);
        u.push(d || ""), (t = p);
      }
      if (!t) return void warn$1(getInvalidTypeMessage(e, n, u));
    }
    a &&
      !a(n, r) &&
      warn$1(
  ...
  updateSlots = (e, t, n) => {
    ...
    if (
      (32 & r.shapeFlag
        ? ((a = t._)
            ? isHmrUpdating
              ? (extend(o, t), trigger(e, "set", "$slots"))
              : n && 1 === a
                ? (s = !1)
      ...
      for (const l in o) isInternalKey(l) || null != i[l] || delete o[l];
  };
    ...
    if (l) {
      ...
      if (
        (null != p &&
          p !== c &&
          (isString(p)
            ? ((d[p] = null), hasOwn(u, p) && (u[p] = null))
            : isRef(p) && (p.value = null)),
        isFunction(c))
      )
        callWithErrorHandling(c, l, 12, [a, d]);
      else {
        const h = isString(c),
          f = isRef(c);
        var e;
        h || f
          ? ((e = () => {
              if (t.f) {
                const e = h ? (hasOwn(u, c) ? u : d)[c] : c.value;
                s
                  ? isArray(e) && remove(e, i)
                  : isArray(e)
                    ? e.includes(i) || e.push(i)
                    : h
                      ? ((d[c] = [i]), hasOwn(u, c) && (u[c] = d[c]))
                      : ((c.value = [i]), t.k && (d[t.k] = c.value));
              } else
                h
                  ? ((d[c] = a), hasOwn(u, c) && (u[c] = a))
                  : f
...
const isSVGContainer = (e) =>
  ...
  getContainerType = (e) =>
    isSVGContainer(e) ? "svg" : isMathMLContainer(e) ? "mathml" : void 0,
...
function createHydrationFunctions(g) {
  ...
  const x = (t, n, e, r, o, s = !1) => {
      const i = isComment(t) && "[" === t.data;
      var a = () => O(t, n, e, r, o, i),
        { type: l, ref: c, shapeFlag: p, patchFlag: d } = n;
      let u = t.nodeType,
        h =
          ("__vnode" in (n.el = t) ||
            Object.defineProperty(t, "__vnode", { value: n, enumerable: !1 }),
          "__vueParentComponent" in t ||
  ...
  - expected on client: ` + JSON.stringify(n.children),
        ...
        case Comment:
          N(t)
            ? ((h = E(t)), k((n.el = t.content.firstChild), t, e))
            : (h = 8 !== u || i ? a() : E(t));
          break;
        case Static:
          if ((i && ((t = E(t)), (u = t.nodeType)), 1 === u || 3 === u)) {
            h = t;
        ...
        default:
          if (1 & p)
            ...
            if (
              ((h = i
                ...
                : isComment(t) && "teleport start" === t.data
                  ? A(t, t.data, "teleport end")
                  : E(t)),
              v(n, m, null, e, r, getContainerType(m), s),
              isAsyncWrapper(n))
            ) {
              let e;
              i
                ? ((e = createVNode(Fragment)).anchor = h
                    ? h.previousSibling
                    : m.lastChild)
                : (e =
                    3 === t.nodeType
            ...
            64 & p
              ? (h = 8 !== u ? a() : n.type.hydrate(t, n, e, r, o, s, g, R))
              : 128 & p
                ? (h = n.type.hydrate(
                    t,
                    n,
      ...
      return null != c && setRef(c, null, r, n), h;
    },
    _ = (n, r, o, s, i, a) => {
      a = a || !!r.dynamicChildren;
      const { type: e, props: l, shapeFlag: c, dirs: p, transition: d } = r;
      var u,
        h = "input" === e || "option" === e;
      {
        p && invokeDirectiveHook(r, null, o, "created");
        let e = !1;
        if (
          (N(n) &&
            ((e =
            ...
            (u = n.content.firstChild),
            e && d.beforeEnter(u),
            k(u, n, o),
            (r.el = n = u)),
          16 & c && (!l || (!l.innerHTML && !l.textContent)))
        ) {
          let e = R(n.firstChild, r, n, o, s, i, a),
            t = !1;
          for (; e; ) {
            (hasMismatch = !0),
              t ||
...
Server rendered element contains more child nodes than client vdom.`,
  ...
  - expected on client: ` + r.children,
        ...
        if (l)
          for (const m in l)
            propHasMismatch(n, m, l[m], r, o) && (hasMismatch = !0),
              ((h && (m.endsWith("value") || "indeterminate" === m)) ||
                (isOn(m) && !isReservedProp(m)) ||
                "." === m[0]) &&
                y(n, m, null, l[m], void 0, void 0, o);
        let t;
        (t = l && l.onVnodeBeforeMount) && invokeVNodeHook(t, o, r),
          p && invokeDirectiveHook(r, null, o, "beforeMount"),
          ((t = l && l.onVnodeMounted) || p || e) &&
            queueEffectWithSuspense(() => {
              t && invokeVNodeHook(t, o, r),
                e && d.enter(n),
...
Server rendered element contains fewer child nodes than client vdom.`,
              ...
              (c = !0)),
            d(null, p, n, null, r, o, getContainerType(n), s));
      }
      return t;
    },
    w = (e, t, n, r, o, s) => {
      var i = t["slotScopeIds"],
        i = (i && (o = o ? o.concat(i) : i), C(e)),
        e = R(E(e), t, i, n, r, o, s);
      return e && isComment(e) && "]" === e.data
        ? E((t.anchor = e))
        : ((hasMismatch = !0), T((t.anchor = a("]")), i, e), e);
    },
    O = (e, t, n, r, o, s) => {
      if (
        ((hasMismatch = !0),
...
- expected on client:`,
      ...
      var s = E(e),
        l = C(e);
      return b(e), d(null, t, l, s, n, r, getContainerType(l), o), s;
    },
    A = (e, t = "[", n = "]") => {
      let r = 0;
      for (; e; )
        if ((e = E(e)) && isComment(e) && (e.data === t && r++, e.data === n)) {
          if (0 === r) return E(e);
          r--;
        }
      return e;
...
function propHasMismatch(e, t, n, r, o) {
  ...
  if ("class" === t)
    (a = e.getAttribute("class")),
      (l = normalizeClass(n)),
      isSetEqual(toClassSet(a || ""), toClassSet(l)) || (s = i = "class");
  else if ("style" === t) {
    (a = e.getAttribute("style")),
      (l = isString(n) ? n : stringifyStyle(normalizeStyle(n)));
    var c = toStyleMap(a);
    const h = toStyleMap(l);
    if (r.dirs)
      for (var { dir: p, value: d } of r.dirs)
        "show" !== p.name || d || h.set("display", "none");
    const f = null == o ? void 0 : o.subTree;
    if (
      r === f ||
      ((null == f ? void 0 : f.type) === Fragment && f.children.includes(r))
    ) {
      var u =
        null == (r = null == o ? void 0 : o.getCssVars) ? void 0 : r.call(o);
      for (const m in u) h.set("--" + m, String(u[m]));
    }
    isMapEqual(c, h) || (s = i = "style");
  } else
    ((e instanceof SVGElement && isKnownSvgAttr(t)) ||
      (e instanceof HTMLElement && (isBooleanAttr(t) || isKnownHtmlAttr(t)))) &&
      ((l = isBooleanAttr(t)
        ? ((a = e.hasAttribute(t)), includeBooleanAttr(n))
        : null == n
          ? ((a = e.hasAttribute(t)), !1)
          : ((a = e.hasAttribute(t)
              ? e.getAttribute(t)
              : "value" === t && "TEXTAREA" === e.tagName && e.value),
            !!isRenderableAttrValue(n) && String(n))),
      a !== l && ((s = "attribute"), (i = t)));
  return (
    !!s &&
    ((r = (e) => (!1 === e ? "(not rendered)" : i + `="${e}"`)),
    warn$1(
...
function baseCreateRenderer(e, t) {
  const n = getGlobalThis(),
    ...
    setDevtoolsHook$1(n.__VUE_DEVTOOLS_GLOBAL_HOOK__, n),
    e),
    O = (
      r,
      o,
      ...
      if (r !== o) {
        r && !isSameVNodeType(r, o) && ((i = Y(r)), G(r, a, l, !0), (r = null)),
          -2 === o.patchFlag && ((d = !1), (o.dynamicChildren = null));
        const { type: A, ref: k, shapeFlag: N } = o;
        switch (A) {
          case Text:
            var e = r,
              t = o,
              n = s,
              u = i;
            if (e == null) L((t.el = $(t.children)), n, u);
            else {
              const I = (t.el = e.el);
              if (t.children !== e.children) X(I, t.children);
            }
            break;
          case Comment:
            j(r, o, s, i);
          ...
          case Static:
            if (null == r)
              (n = o),
                ...
                (e = i),
                (t = c),
                ([n.el, n.anchor] = B(n.children, u, e, t, n.el, n.anchor));
            else {
              var h = r,
                f = o,
                m = s,
              ...
              if (f.children !== h.children) {
                const P = H(h.anchor);
                U(h);
                [f.el, f.anchor] = B(f.children, m, P, g);
              } else {
                f.el = h.el;
                f.anchor = h.anchor;
              }
          ...
          case Fragment:
            {
              ...
              if (m == null) {
                L(M, f, h);
                L(V, f, h);
                K(g.children || [], f, V, v, y, S, E, C);
              } else if (e > 0 && e & 64 && t && m.dynamicChildren) {
                z(m.dynamicChildren, t, f, v, y, S, E);
                traverseStaticChildren(m, g);
              } else q(m, g, f, V, v, y, S, E, C);
            }
            break;
          default:
            if (1 & N) {
              var v = r,
                ...
                _ = d;
              if (y.type === "svg") T = "svg";
              else if (y.type === "math") T = "mathml";
              if (v == null) Z(y, S, E, C, b, T, x, _);
              else Q(v, y, C, b, T, x, _);
            } else if (6 & N) {
              var b = r,
                T = o,
                x = s,
              ...
              if (((T.slotScopeIds = D), b == null))
                if (T.shapeFlag & 512) R.ctx.activate(T, x, _, w, O);
                else W(T, x, _, R, F, w, O);
              else ee(b, T, O);
            } else
              64 & N || 128 & N
                ? A.process(r, o, s, i, a, l, c, p, d, J)
                : warn$1("Invalid VNode type:", A, `(${typeof A})`);
        }
    ...
    U = ({ el: e, anchor: t }) => {
      for (var n; e && e !== t; ) (n = H(e)), u(e), (e = n);
      u(t);
    },
    Z = (e, t, n, r, o, s, i, a) => {
      let l, c;
      const { props: p, shapeFlag: d, transition: u, dirs: h } = e;
      if (
        ((l = e.el = g(e.type, s, p && p.is, p)),
        8 & d
          ? x(l, e.children)
          : 16 & d &&
            K(e.children, l, null, r, o, resolveChildrenNamespace(e, s), i, a),
        ...
        for (const m in p)
          "value" === m ||
            isReservedProp(m) ||
            y(l, m, null, p[m], s, e.children, r, o, R);
        "value" in p && y(l, "value", null, p.value, s),
          (c = p.onVnodeBeforeMount) && invokeVNodeHook(c, r, e);
      }
      ...
      const f = needTransition(o, u);
      f && u.beforeEnter(l),
        L(l, t, n),
        ((c = p && p.onVnodeMounted) || f || h) &&
          queuePostRenderEffect(() => {
        ...
        n ===
          (e =
            0 < e.patchFlag && 2048 & e.patchFlag
              ...
              : e) &&
          ((r = s.vnode), v(t, r, r.scopeId, r.slotScopeIds, s.parent));
      }
    },
    ...
    Q = (t, e, n, r, o, s, i) => {
      ...
      if (
        (n && toggleRecurse(n, !1),
        (h = u.onVnodeBeforeUpdate) && invokeVNodeHook(h, n, e, t),
        ...
        c
          ? (z(
              ...
              n,
              r,
              resolveChildrenNamespace(e, o),
              s,
            ),
            traverseStaticChildren(t, e))
          : i || q(t, e, a, null, n, r, resolveChildrenNamespace(e, o), s, !1),
        0 < l)
      ) {
        if (16 & l) S(a, e, d, u, n, r, o);
        else if (
          (2 & l && d.class !== u.class && y(a, "class", null, u.class, o),
          4 & l && y(a, "style", d.style, u.style, o),
          8 & l)
        ) {
          ...
          for (let e = 0; e < f.length; e++) {
            var m = f[e],
              g = d[m],
              v = u[m];
            (v === g && "value" !== m) || y(a, m, g, v, o, t.children, n, r, R);
          }
        }
        1 & l && t.children !== e.children && x(a, e.children);
      } else i || null != c || S(a, e, d, u, n, r, o);
      ((h = u.onVnodeUpdated) || p) &&
        queuePostRenderEffect(() => {
          h && invokeVNodeHook(h, n, e, t),
      ...
      if (n !== r) {
        if (n !== EMPTY_OBJ)
          for (const c in n)
            isReservedProp(c) ||
              c in r ||
              y(e, c, n[c], null, i, t.children, o, s, R);
        for (const p in r) {
          var a, l;
          isReservedProp(p) ||
            ((a = r[p]) !== (l = n[p]) &&
              "value" !== p &&
              y(e, p, l, a, i, t.children, o, s, R));
        }
        "value" in r && y(e, "value", n.value, r.value, i);
      }
    },
    W = (e, t, n, r, o, s, i) => {
      ...
      a.type.__hmrId && registerHMR(a),
        ...
        a.asyncDep
          ? (o && o.registerDep(a, l),
            e.el || ((r = a.subTree = createVNode(Comment)), j(null, r, t, n)))
          : l(a, e, t, n, o, s, i),
        popWarningContext(),
        endMeasure(a, "mount");
    },
    ee = (e, t, n) => {
      ...
      shouldUpdateComponent(e, t, n)
        ? r.asyncDep && !r.asyncResolved
          ? (pushWarningContext(t), C(r, t, n), popWarningContext())
          : ((r.next = t),
    ...
    l = (u, h, f, m, g, v, y) => {
      const S = () => {
          if (u.isMounted) {
            ...
            {
              const c = locateNonHydratedAsyncRoot(u);
              if (c)
                return (
                  e && ((e.el = o.el), C(u, e, y)),
            ...
            (u.subTree = a),
              ...
              O(l, a, E(l.el), Y(l), u, g, v),
              endMeasure(u, "patch"),
              (e.el = a.el),
              null === i && updateHOCHostEl(u, a.el),
              n && queuePostRenderEffect(n, g),
              (s = e.props && e.props.onVnodeUpdated) &&
                queuePostRenderEffect(() => invokeVNodeHook(s, r, e, o), g),
            ...
            if (
              (toggleRecurse(u, !1),
              r && invokeArrayFns(r),
              !l && (e = n && n.onVnodeBeforeMount) && invokeVNodeHook(e, s, h),
              toggleRecurse(u, !0),
              t && b)
            ) {
              const p = () => {
                startMeasure(u, "render"),
                  ...
                  b(t, u.subTree, u, g, null),
                  endMeasure(u, "hydrate");
              };
              l
                ? h.type.__asyncLoader().then(() => !u.isUnmounted && p())
                : p();
            } else {
              startMeasure(u, "render");
            ...
            if (
              (o && queuePostRenderEffect(o, g),
              !l && (e = n && n.onVnodeMounted))
            ) {
              const d = h;
              queuePostRenderEffect(() => invokeVNodeHook(e, s, d), g);
            }
            (256 & h.shapeFlag ||
              (s && isAsyncWrapper(s.vnode) && 256 & s.vnode.shapeFlag)) &&
              u.a &&
              queuePostRenderEffect(u.a, g),
              (u.isMounted = !0),
              devtoolsComponentAdded(u),
              (h = f = m = null);
          }
        },
        e = (u.effect = new ReactiveEffect(
          S,
          NOOP,
          () => queueJob(t),
          u.scope,
    ...
    q = (e, t, n, r, o, s, i, a, l = !1) => {
      var c = e && e.children,
        e = e ? e.shapeFlag : 0,
        p = t.children,
        { patchFlag: t, shapeFlag: d } = t;
      if (0 < t) {
        if (128 & t) return void _(c, p, n, r, o, s, i, a, l);
        if (256 & t) {
          {
            var u = c;
            var h = p;
            ...
            for (e = 0; e < b; e++) {
              const T = (h[e] = S
                ? cloneIfMounted(h[e])
                : normalizeVNode(h[e]));
              O(u[e], T, f, null, m, g, v, y, S);
            }
            if (E > C) R(u, m, g, true, false, b);
            else K(h, f, t, m, g, v, y, S, b);
          }
          return;
        }
      }
      8 & d
        ? (16 & e && R(c, o, s), p !== c && x(n, p))
        : 16 & e
          ? 16 & d
            ? _(c, p, n, r, o, s, i, a, l)
            : R(c, o, s, !0)
          : (8 & e && x(n, ""), 16 & d && K(p, n, r, o, s, i, a, l));
    },
    _ = (e, s, i, a, l, c, p, d, u) => {
      let h = 0;
      var f = s.length;
      ...
      for (; h <= m && h <= g; ) {
        var t = e[h],
          n = (s[h] = (u ? cloneIfMounted : normalizeVNode)(s[h]));
        if (!isSameVNodeType(t, n)) break;
        O(t, n, i, null, l, c, p, d, u), h++;
      }
      for (; h <= m && h <= g; ) {
        var r = e[m],
          o = (s[g] = (u ? cloneIfMounted : normalizeVNode)(s[g]));
        if (!isSameVNodeType(r, o)) break;
        O(r, o, i, null, l, c, p, d, u), m--, g--;
      }
      if (h > m) {
        if (h <= g)
          for (var v = g + 1, y = v < f ? s[v].el : a; h <= g; )
            O(
              null,
              (s[h] = (u ? cloneIfMounted : normalizeVNode)(s[h])),
              i,
              y,
              l,
              c,
              ...
              h++;
      } else if (h > g) for (; h <= m; ) G(e[h], l, c, !0), h++;
      else {
        var v = h,
          S = h;
        const R = new Map();
        for (h = S; h <= g; h++) {
          var E = (s[h] = (u ? cloneIfMounted : normalizeVNode)(s[h]));
          null != E.key &&
            (R.has(E.key) &&
              warn$1(
        ...
        for (h = v; h <= m; h++) {
          ...
          if (n >= C) G(b, l, c, !0);
            ...
            let e;
            if (null != b.key) e = R.get(b.key);
            else
              for (t = S; t <= g; t++)
                if (0 === w[t - S] && isSameVNodeType(b, s[t])) {
                  e = t;
                  break;
                }
            void 0 === e
              ...
              : ((w[e - S] = h + 1),
                e >= o ? (o = e) : (r = !0),
                O(b, s[e], i, null, l, c, p, d, u),
                n++);
          }
        }
        var T = r ? getSequence(w) : EMPTY_ARR;
        for (t = T.length - 1, h = C - 1; 0 <= h; h--) {
          var x = S + h,
            _ = s[x],
            x = x + 1 < f ? s[x + 1].el : a;
          0 === w[h]
            ? O(null, _, i, x, l, c, p, d, u)
            : r && (t < 0 || h !== T[t] ? A(_, i, x, 2) : t--);
        }
      }
    },
    A = (e, t, n, r, o = null) => {
      ...
      if (6 & c) A(e.component.subTree, t, n, r);
        ...
        for (var p, [{ el: d, anchor: u }, h, f] = [e, t, n]; d && d !== u; )
          (p = H(d)), L(d, h, f), (d = p);
        L(u, h, f);
      } else if (2 !== r && 1 & c && a)
        if (0 === r)
          ...
          const { leave: m, delayLeave: g, afterLeave: v } = a,
            y = () => L(s, t, n);
          e = () => {
            m(s, () => {
              y(), v && v();
        ...
        if (
          ...
          f && invokeDirectiveHook(t, null, n, "beforeUnmount"),
            64 & d
              ...
              : p && (i !== Fragment || (0 < u && 64 & u))
                ? R(p, n, r, !1, !0)
                : ((i === Fragment && 384 & u) || (!s && 16 & d)) && R(c, n, r),
            o && m(t);
        }
      ...
      if (t === Fragment)
        if (0 < e.patchFlag && 2048 & e.patchFlag && o && !o.persisted)
          e.children.forEach((e) => {
            e.type === Comment ? u(e.el) : m(e);
          });
        else {
          var s = n;
          var i = r;
          var a;
          for (; s !== i; ) (a = H(s)), u(s), (s = a);
          u(i);
        }
    ...
    R = (t, n, r, o = !1, s = !1, i = 0) => {
      for (let e = i; e < t.length; e++) G(t[e], n, r, o, s);
    },
    Y = (e) =>
      6 & e.shapeFlag
  ...
  var s = (e, t, n) => {
    null == e
      ...
      r || ((r = !0), flushPreFlushCbs(), flushPostFlushCbs(), (r = !1)),
      (t._vnode = e);
  };
  const J = {
    p: O,
  ...
  return (
    t && ([a, b] = t(J)),
    { render: s, hydrate: a, createApp: createAppAPI(s, a) }
  );
}
...
const isTeleport = (e) => e.__isTeleport,
  ...
  TeleportImpl = {
    ...
    process(e, t, n, r, o, s, i, a, l, c) {
      ...
      let { shapeFlag: T, children: x, dynamicChildren: _ } = t;
      isHmrUpdating && ((l = !1), (_ = null)),
        null == e
          ? ((S = t.el = g("teleport start")),
            (v = t.anchor = g("teleport end")),
            h(S, n, r),
            h(v, n, r),
            (S = t.target = resolveTarget(t.props, f)),
            (r = t.targetAnchor = m("")),
            S
              ? (h(r, S),
                "svg" === i || isTargetSVG(S)
                  ? (i = "svg")
                  : ("mathml" !== i && !isTargetMathML(S)) || (i = "mathml"))
              : b ||
                warn$1("Invalid Teleport target on mount:", S, `(${typeof S})`),
            (y = (e, t) => {
              16 & T && p(x, e, t, o, s, i, a, l);
            }),
            b ? y(n, v) : S && y(S, r))
          : ((t.el = e.el),
            (v = t.anchor = e.anchor),
            ...
            "svg" === i || isTargetSVG(y)
              ? (i = "svg")
              : ("mathml" !== i && !isTargetMathML(y)) || (i = "mathml"),
            _
              ? (u(e.dynamicChildren, _, C, o, s, i, a),
                traverseStaticChildren(e, t, !0))
              : l || d(e, t, C, E, o, s, i, a, !1),
            b
              ? r
                ? t.props &&
                  e.props &&
                  ...
                  (t.props.to = e.props.to)
                : moveTeleport(t, n, v, c, 1)
              : (t.props && t.props.to) !== (e.props && e.props.to)
                ? (C = t.target = resolveTarget(t.props, f))
    ...
    remove(e, t, n, r, { um: o, o: { remove: s } }, i) {
      ...
      if ((p && s(c), i && s(l), 16 & e)) {
        var u = i || !isTeleportDisabled(d);
        for (let e = 0; e < a.length; e++) {
          var h = a[e];
          o(h, t, n, u, !!h.dynamicChildren);
        }
      }
    },
    move: moveTeleport,
...
function setupComponent(e, t = !1) {
  ...
  return t && setInSSRSetupState(!1), n;
}
function setupStatefulComponent(t, n) {
  ...
  if (s) {
    ...
    const a = setCurrentInstance(t),
      l =
        (pauseTracking(),
        callWithErrorHandling(s, t, 0, [shallowReadonly(t.props), i]));
    if ((resetTracking(), a(), isPromise(l))) {
      if ((l.then(unsetCurrentInstance, unsetCurrentInstance), n))
        return l
          .then((e) => {
...
function getSlotsProxy(n) {
  return (
    n.slotsProxy ||
    (n.slotsProxy = new Proxy(n.slots, {
      get(e, t) {
        return track(n, "get", "$slots"), e[t];
      },
    }))
  );
}
function createSetupContext(n) {
  return Object.freeze({
    get attrs() {
      return getAttrsProxy(n);
    },
    get slots() {
      return getSlotsProxy(n);
    },
    get emit() {
    ...
    expose: (t) => {
      if (
        ...
        "object" === e &&
          ...
          "object" !== e &&
            warn$1(`expose() should be passed a plain object, received ${e}.`);
      }
      n.exposed = t || {};
    },
  });
...
const computed = (e, t) => {
  ...
  return (
    e && e.appContext.config.warnRecursiveComputed && (n._warnRecursive = !0), n
  );
};
function useModel(t, o, s = EMPTY_OBJ) {
  const i = getCurrentInstance();
  if (!i) return warn$1("useModel() called without active instance."), ref();
  if (!i.propsOptions[0][o])
    return (
      warn$1(`useModel() called with prop "${o}" which is not declared.`), ref()
    );
  const a = camelize(o),
    l = hyphenate(o),
    n = customRef((e, n) => {
      ...
      return (
        watchSyncEffect(() => {
          var e = t[o];
          hasChanged(r, e) && ((r = e), n());
        }),
        {
          get() {
            return e(), s.get ? s.get(r) : r;
          },
          set(e) {
            var t = i.vnode.props;
            (t &&
              (o in t || a in t || l in t) &&
              ("onUpdate:" + o in t ||
                "onUpdate:" + a in t ||
                "onUpdate:" + l in t)) ||
              !hasChanged(e, r) ||
              ((r = e), n()),
              i.emit("update:" + o, s.set ? s.set(e) : e);
          },
        }
      );
    }),
                ...
                : isReadonly(e)
                  ? [
                      ...
                      [
                        "span",
                        t,
                        isShallow(e) ? "ShallowReadonly" : "Readonly",
                      ],
                      "<",
                      n(e),
                      ">",
...
function resolveTransitionProps(e) {
  const t = {};
  for (const w in e) w in DOMTransitionPropsValidators || (t[w] = e[w]);
  if (!1 === e.css) return t;
  const {
    name: n = "v",
    type: s,
      ...
      addTransitionClass(e, d),
        ...
        nextFrame(() => {
          e._isLeaving &&
            ...
            hasExplicitCallback(E) || whenTransitionEnds(e, s, g, n));
        }),
        callHook(E, [e, n]);
    },
    onEnterCancelled(e) {
...
function addTransitionClass(t, e) {
  e.split(/\s+/).forEach((e) => e && t.classList.add(e)),
    (t[vtcKey] || (t[vtcKey] = new Set())).add(e);
}
function removeTransitionClass(t, e) {
  e.split(/\s+/).forEach((e) => e && t.classList.remove(e));
  const n = t[vtcKey];
  n && (n.delete(e), n.size || (t[vtcKey] = void 0));
}
    ...
    if (t)
      if (isString(t))
        for (const a of t.split(";")) {
          ...
          null == n[i] && setStyle(r, i, "");
        }
      else for (const l in t) null == n[l] && setStyle(r, l, "");
    for (const c in n) "display" === c && (s = !0), setStyle(r, c, n[c]);
  } else
    o
      ? t !== n &&
        ((o = r[CSS_VAR_TEXT]) && (n += ";" + o),
        (r.cssText = n),
        (s = displayRE.test(n)))
      : t && e.removeAttribute("style");
  vShowOriginalDisplay in e &&
    ((e[vShowOriginalDisplay] = s ? r.display : ""),
...
function patchDOMProp(e, t, n, r, o, s, i) {
  ...
  if ("value" === t && "PROGRESS" !== a && !a.includes("-"))
    return (
      (i = null == n ? "" : n),
      (("OPTION" === a ? e.getAttribute("value") || "" : e.value) === i &&
        "_value" in e) ||
        (e.value = i),
...
function shouldSetAsProp(e, t, n, r) {
  if (r)
    return (
      "innerHTML" === t ||
      "textContent" === t ||
      !!(t in e && isNativeOn(t) && isFunction(n))
    );
  ...
  return (!isNativeOn(t) || !isString(n)) && t in e;
}
...
const assignKey = Symbol("_assign"),
  vModelText = {
    ...
    beforeUpdate(
      ...
      if (((e[assignKey] = getModelAssigner(s)), !e.composing)) {
        (s = o || "number" === e.type ? looseToNumber(e.value) : e.value),
          (o = null == t ? "" : t);
        if (s !== o) {
  ...
  vModelCheckbox = {
    deep: !0,
    created(l, e, t) {
      (l[assignKey] = getModelAssigner(t)),
  ...
  vModelSelect = {
    ...
    created(t, { value: e, modifiers: { number: n } }, r) {
      ...
      addEventListener(t, "change", () => {
        ...
        t[assignKey](t.multiple ? (o ? new Set(e) : e) : e[0]),
          (t._assigning = !0),
          nextTick(() => {
            t._assigning = !1;
          });
      }),
        (t[assignKey] = getModelAssigner(r));
    },
    ...
    updated(e, { value: t, modifiers: { number: n } }) {
      e._assigning || setSelected(e, t, n);
    },
  };
function setSelected(n, r, o) {
  var s = n.multiple,
    i = isArray(r);
  if (!s || i || isSet(r)) {
      ...
      if (s)
        i
          ? ((a = typeof l),
            (c.selected =
              "string" == a || "number" == a
                ? r.includes(o ? looseToNumber(l) : l)
                : -1 < looseIndexOf(r, l)))
          : (c.selected = r.has(l));
      else if (looseEqual(getValue(c), r))
      ...
      (r.mount = (e) => {
        ...
        if (t) {
          ...
          isFunction(n) || n.render || n.template || (n.template = t.innerHTML),
            (t.innerHTML = "");
          e = o(t, !1, resolveRootNamespace(t));
          return (
  ...
  createSSRApp = (...e) => {
    ...
    return (
      (t.mount = (e) => {
        ...
        if (e) return n(e, !0, resolveRootNamespace(e));
      }),
      t
    );
  };
...
function injectNativeTagCheck(e) {
  Object.defineProperty(e.config, "isNativeTag", {
    value: (e) => isHTMLTag(e) || isSVGTag(e) || isMathMLTag(e),
    writable: !1,
  });
}
...
function isEndOfTagSection(e) {
  return 47 === e || 62 === e || isWhitespace(e);
}
function toCharCodes(t) {
...
class Tokenizer {
  ...
  stateCDATASequence(e) {
    e === Sequences.Cdata[this.sequenceIndex]
  ...
  stateInTagName(e) {
    isEndOfTagSection(e) && this.handleTagName(e);
  }
  stateInSFCRootTagName(e) {
    var t;
    isEndOfTagSection(e) &&
      ("template" !== (t = this.buffer.slice(this.sectionStart, this.index)) &&
        this.enterRCDATA(toCharCodes("</" + t), 0),
    ...
    isWhitespace(e) ||
      (62 === e
        ? (this.cbs.onerr(14, this.index),
          (this.state = 1),
          (this.sectionStart = this.index + 1))
        : ((this.state = isTagStartChar(e) ? 9 : 27),
          (this.sectionStart = this.index)));
  }
  ...
  stateInSelfClosingTag(e) {
    62 === e
      ? (this.cbs.onselfclosingtag(this.index),
        ...
        (this.sectionStart = this.index + 1),
        (this.inRCDATA = !1))
      : isWhitespace(e) || ((this.state = 11), this.stateBeforeAttrName(e));
  }
  stateInAttrName(e) {
    61 === e || isEndOfTagSection(e)
  ...
  stateBeforeSpecialS(e) {
    e === Sequences.ScriptEnd[3]
      ? this.startSpecial(Sequences.ScriptEnd, 4)
      : e === Sequences.StyleEnd[3]
        ? this.startSpecial(Sequences.StyleEnd, 4)
        : ((this.state = 6), this.stateInTagName(e));
  }
  stateBeforeSpecialT(e) {
    e === Sequences.TitleEnd[3]
      ? this.startSpecial(Sequences.TitleEnd, 4)
      : e === Sequences.TextareaEnd[3]
...
Use a v-bind binding combined with a v-on listener that emits update:x event instead.`,
  ...
  isStaticExp = (e) => 4 === e.type && e.isStatic;
...
const stack = [],
  tokenizer = new Tokenizer(stack, {
    ...
    oninterpolation(e, t) {
      if (inVPre) return onText(getSlice(e, t), e, t);
      let n = e + tokenizer.delimiterOpen.length,
        r = t - tokenizer.delimiterClose.length;
      for (; isWhitespace(currentInput.charCodeAt(n)); ) n++;
      for (; isWhitespace(currentInput.charCodeAt(r - 1)); ) r--;
      let o = getSlice(n, r);
      addNode({
        type: 5,
        content: createExp(
          (o = o.includes("&") ? currentOptions.decodeEntities(o, !1) : o),
          !1,
          getLoc(n, r),
        ),
        loc: getLoc(e, t),
    ...
    onclosetag(t, n) {
      const r = getSlice(t, n);
      if (!currentOptions.isVoidTag(r)) {
        let e = !1;
        for (let t = 0; t < stack.length; t++) {
          const o = stack[t];
          if (o.tag.toLowerCase() === r.toLowerCase()) {
            (e = !0), 0 < t && emitError(24, stack[0].loc.start.offset);
            for (let e = 0; e <= t; e++) onCloseTag(stack.shift(), n, e < t);
            break;
          }
        }
        e || emitError(23, backTrack(t, 60));
      }
    },
    onselfclosingtag(e) {
      var t,
        n = currentOpenTag.tag;
      (currentOpenTag.isSelfClosing = !0),
        endOpenTag(e),
        (null == (t = stack[0]) ? void 0 : t.tag) === n &&
          onCloseTag(stack.shift(), e);
    },
    onattribname(e, t) {
      currentProp = {
        type: 6,
    ...
    ondirname(e, t) {
      ...
      if ((inVPre || "" !== r || emitError(26, e), inVPre || "" === r))
        ...
        inVPre = tokenizer.inVPre = !0;
        const o = (currentVPreBoundary = currentOpenTag).props;
        for (let e = 0; e < o.length; e++)
          7 === o[e].type && (o[e] = dirToAttr(o[e]));
      }
    },
    ondirarg(e, t) {
      if (e !== t) {
        const r = getSlice(e, t);
        var n;
        inVPre
          ? ((currentProp.name += r), setLocEnd(currentProp.nameLoc, t))
          : ((n = "[" !== r[0]),
    ...
    ondirmodifier(e, t) {
      e = getSlice(e, t);
      if (inVPre)
        (currentProp.name += "." + e), setLocEnd(currentProp.nameLoc, t);
      else if ("slot" === currentProp.name) {
        const n = currentProp.arg;
        n && ((n.content += "." + e), setLocEnd(n.loc, t));
      } else currentProp.modifiers.push(e);
    },
    onattribdata(e, t) {
      (currentAttrValue += getSlice(e, t)),
        currentAttrStartIndex < 0 && (currentAttrStartIndex = e),
        (currentAttrEndIndex = t);
    },
    onattribentity(e, t, n) {
      (currentAttrValue += e),
        currentAttrStartIndex < 0 && (currentAttrStartIndex = t),
        (currentAttrEndIndex = n);
    },
    onattribnameend(e) {
      var t = currentProp.loc.start.offset;
      const n = getSlice(t, e);
      7 === currentProp.type && (currentProp.rawName = n),
    ...
    onattribend(e, t) {
      currentOpenTag &&
        ...
        0 !== e &&
          ...
          6 === currentProp.type
            ? ("class" === currentProp.name &&
                (currentAttrValue = condense(currentAttrValue).trim()),
              1 !== e || currentAttrValue || emitError(13, t),
              (currentProp.value = {
                type: 2,
              ...
              tokenizer.inSFCRoot &&
                "template" === currentOpenTag.tag &&
                "lang" === currentProp.name &&
                currentAttrValue &&
                "html" !== currentAttrValue &&
            ...
            : ((currentProp.exp = createExp(
              ...
              "for" === currentProp.name &&
                (currentProp.forParseResult = parseForExpression(
                  currentProp.exp,
                )))),
        (7 === currentProp.type && "pre" === currentProp.name) ||
    ...
    onend() {
      var t = currentInput.length;
      if (1 !== tokenizer.state)
        switch (tokenizer.state) {
          ...
          case 4:
            ...
            break;
          case 28:
            tokenizer.currentSequence === Sequences.CdataEnd
              ? emitError(6, t)
              : emitError(7, t);
            break;
          case 6:
      ...
      for (let e = 0; e < stack.length; e++)
        onCloseTag(stack[e], t - 1), emitError(24, stack[e].loc.start.offset);
    },
    oncdata(e, t) {
      0 !== stack[0].ns ? onText(getSlice(e, t), e, t) : emitError(1, e - 9);
    },
    onprocessinginstruction(e) {
      0 === (stack[0] || currentOptions).ns && emitError(21, e - 1);
    },
  }),
  forIteratorRE = /,([^,\}\]]*)(?:,([^,\}\]]*))?$/,
  stripParensRE = /^\(|\)$/g;
function parseForExpression(n) {
  const r = n.loc,
    o = n.content;
  n = o.match(forAliasRE);
  if (n) {
    const [, e, l] = n;
    n = (e, t, n = !1) => {
      t = r.start.offset + t;
      return createExp(e, !1, getLoc(t, t + e.length), 0, n ? 1 : 0);
    };
    const c = {
      source: n(l.trim(), o.indexOf(l, e.length)),
      value: void 0,
      key: void 0,
      index: void 0,
      finalized: !1,
    ...
    if (p) {
      ...
      var i,
        a = p[1].trim();
      let e;
      a && ((e = o.indexOf(a, s + t.length)), (c.key = n(a, e, !0))),
        !p[2] ||
          ((i = p[2].trim()) &&
            (c.index = n(
              i,
              o.indexOf(i, c.key ? e + a.length : s + t.length),
              !0,
            )));
    }
    return t && (c.value = n(t, s, !0)), c;
  }
}
...
function endOpenTag(e) {
  tokenizer.inSFCRoot && (currentOpenTag.innerLoc = getLoc(e + 1, e + 1)),
    addNode(currentOpenTag);
  var { tag: t, ns: n } = currentOpenTag;
  0 === n && currentOptions.isPreTag(t) && inPre++,
    currentOptions.isVoidTag(t)
      ? onCloseTag(currentOpenTag, e)
      : (stack.unshift(currentOpenTag),
        (1 !== n && 2 !== n) || (tokenizer.inXML = !0)),
    (currentOpenTag = null);
}
function onText(e, t, n) {
  var r = null == (r = stack[0]) ? void 0 : r.tag;
  "script" !== r &&
    "style" !== r &&
    e.includes("&") &&
    (e = currentOptions.decodeEntities(e, !1));
  const o = stack[0] || currentRoot,
    s = o.children[o.children.length - 1];
  2 === (null == s ? void 0 : s.type)
    ? ((s.content += e), setLocEnd(s.loc, n))
    : o.children.push({ type: 2, content: e, loc: getLoc(t, n) });
}
function onCloseTag(e, t, n = !1) {
  setLocEnd(e.loc, n ? backTrack(t, 60) : t + 1),
    tokenizer.inSFCRoot &&
      (e.children.length
        ? (e.innerLoc.end = extend(
            {},
            e.children[e.children.length - 1].loc.end,
          ))
        : (e.innerLoc.end = extend({}, e.innerLoc.start)),
      (e.innerLoc.source = getSlice(
  ...
  inVPre ||
    ("slot" === n
      ? (e.tagType = 2)
      : isFragmentTemplate(e)
        ? (e.tagType = 3)
        : isComponent(e) && (e.tagType = 1)),
    tokenizer.inRCDATA || (e.children = condenseWhitespace(e.children, e.tag)),
    0 === t && currentOptions.isPreTag(n) && inPre--,
    currentVPreBoundary === e &&
      ((inVPre = tokenizer.inVPre = !1), (currentVPreBoundary = null)),
    tokenizer.inXML &&
      0 === (stack[0] || currentOptions).ns &&
      (tokenizer.inXML = !1);
}
function backTrack(e, t) {
  let n = e;
  for (; currentInput.charCodeAt(n) !== t && 0 <= n; ) n--;
  return n;
}
...
function isFragmentTemplate({ tag: e, props: t }) {
  if ("template" === e)
    for (let e = 0; e < t.length; e++)
      if (7 === t[e].type && specialTemplateDir.has(t[e].name)) return !0;
  return !1;
}
function isComponent({ tag: e, props: t }) {
  var n;
  if (currentOptions.isCustomElement(e)) return !1;
  if (
    "component" === e ||
    isUpperCase(e.charCodeAt(0)) ||
    isCoreComponent(e) ||
    (null != (n = currentOptions.isBuiltInComponent) &&
      n.call(currentOptions, e)) ||
    (currentOptions.isNativeTag && !currentOptions.isNativeTag(e))
  )
    return !0;
  for (let e = 0; e < t.length; e++) {
    const r = t[e];
...
function condenseWhitespace(t, e) {
  var n,
    r,
    o = "preserve" !== currentOptions.whitespace;
  let s = !1;
  for (let e = 0; e < t.length; e++) {
    const i = t[e];
    2 === i.type &&
      (inPre
        ...
        : isAllWhitespace(i.content)
          ? ((n = null == (n = t[e - 1]) ? void 0 : n.type),
            ...
            (o &&
              ((3 === n && (3 === r || 1 === r)) ||
                (1 === n &&
                  (3 === r || (1 === r && hasNewlineChar(i.content))))))
              ? ((s = !0), (t[e] = null))
              : (i.content = " "))
          : o && (i.content = condense(i.content)));
  }
  if (inPre && e && currentOptions.isPreTag(e)) {
    const a = t[0];
...
function isAllWhitespace(t) {
  for (let e = 0; e < t.length; e++)
    if (!isWhitespace(t.charCodeAt(e))) return !1;
  return !0;
}
function hasNewlineChar(t) {
  for (let e = 0; e < t.length; e++) {
...
function getLoc(e, t) {
  return {
    ...
    end: null == t ? t : tokenizer.getPos(t),
    source: null == t ? t : getSlice(e, t),
  };
}
...
function dirToAttr(e) {
  const t = {
    type: 6,
    name: e.rawName,
    nameLoc: getLoc(e.loc.start.offset, e.loc.start.offset + e.rawName.length),
    value: void 0,
    loc: e.loc,
  };
  if (e.exp) {
...
function createExp(e, t = !1, n, r = 0, o) {
  return createSimpleExpression(e, t, n, r);
}
function emitError(e, t, n) {
  currentOptions.onError(createCompilerError(e, getLoc(t, t), void 0, n));
}
function reset() {
  tokenizer.reset(),
    (currentOpenTag = null),
...
function baseParse(e, t) {
  if (
    ...
    let e;
    for (e in t) null != t[e] && (currentOptions[e] = t[e]);
  }
  ...
  (tokenizer.mode =
    "html" === currentOptions.parseMode
      ? 1
      : "sfc" === currentOptions.parseMode
        ? 2
        : 0),
    (tokenizer.inXML = 1 === currentOptions.ns || 2 === currentOptions.ns);
  var n = null == t ? void 0 : t.delimiters;
  n &&
    ((tokenizer.delimiterOpen = toCharCodes(n[0])),
    (tokenizer.delimiterClose = toCharCodes(n[1])));
  const r = (currentRoot = createRoot([], e));
  return (
    tokenizer.parse(currentInput),
    (r.loc = getLoc(0, e.length)),
    (r.children = condenseWhitespace(r.children)),
    (currentRoot = null),
    r
  );
}
...
function walk(e, t, n = !1) {
  ...
  if (
    ...
    const c = t.hoist(createArrayExpression(e.codegenNode.children));
    t.hmr && (c.content = `[...${c.content}]`), (e.codegenNode.children = c);
  }
}
...
function createTransformContext(
  ...
  const x = {
    ...
    helperString(e) {
      return "_" + helperNameMap[x.helper(e)];
    },
    replaceNode(e) {
      if (!x.currentNode)
    ...
    removeIdentifiers(e) {},
    hoist(e) {
      isString(e) && (e = createSimpleExpression(e)), x.hoists.push(e);
    ...
    cache(e, t = !1) {
      return createCacheExpression(x.cached++, e, t);
    },
  };
  return x;
}
...
function createRootCodegen(n, r) {
  ...
  if (1 === s.length) {
    ...
    isSingleElementRoot(n, t) && t.codegenNode
      ? (13 === (e = t.codegenNode).type && convertToBlock(e, r),
        (n.codegenNode = e))
      : (n.codegenNode = t);
  } else if (1 < s.length) {
    let e = 64,
...
function generate(t, e = {}) {
  ...
  if (
    ...
    d &&
      ...
      e &&
        (o(
          `const { ${p.map(aliasHelper).join(", ")} } = _Vue
`,
          -1,
        ),
        l())),
...
function genAssets(n, r, { helper: e, push: o, newline: s, isTS: i }) {
  ...
  for (let t = 0; t < n.length; t++) {
    ...
    o(
      `const ${toValidAssetId((e = l ? e.slice(0, -6) : e), r)} = ${a}(${JSON.stringify(e)}${l ? ", true" : ""})` +
        (i ? "!" : ""),
    ),
      t < n.length - 1 && s();
  }
...
function genNodeList(t, n, r = !1, o = !0) {
  ...
  for (let e = 0; e < t.length; e++) {
    var a = t[e];
    isString(a) ? s(a, -3) : (isArray(a) ? genNodeListAsArray : genNode)(a, n),
      e < t.length - 1 && (r ? (o && s(","), i()) : o && s(", "));
  }
}
function genNode(e, t) {
  if (isString(e)) t.push(e, -3);
...
function genCompoundExpression(t, n) {
  for (let e = 0; e < t.children.length; e++) {
    var r = t.children[e];
    isString(r) ? n.push(r, -3) : genNode(r, n);
  }
}
...
function genComment(e, t) {
  const { push: n, helper: r, pure: o } = t;
  o && n(PURE_ANNOTATION),
    n(`${r(CREATE_COMMENT)}(${JSON.stringify(e.content)})`, -3, e);
}
function genVNodeCall(e, t) {
  ...
  var {
    ...
    u =
      ...
      d && n(`(${r(OPEN_BLOCK)}(${u ? "true" : ""}), `),
      o && n(PURE_ANNOTATION),
      (d ? getVNodeBlockHelper : getVNodeHelper)(t.inSSR, h));
  n(r(u) + "(", -2, e),
...
const transformFor = createStructuralDirectiveTransform("for", (u, e, h) => {
  const { helper: f, removeHelper: m } = h;
  return processFor(u, e, h, (s) => {
    const i = createCallExpression(f(RENDER_LIST), [s.source]),
      a = isTemplateNode(u),
      l = findDir(u, "memo");
    var e = findProp(u, "key");
    const c =
        e &&
          ...
          n =
            (a &&
              u.children.some((e) => {
                if (1 === e.type) {
                  e = findProp(e, "key");
                  if (e) return h.onError(createCompilerError(33, e.loc)), !0;
                }
              }),
            1 !== t.length || 1 !== t[0].type),
          r = isSlotOutlet(u)
            ? u
            : a && 1 === u.children.length && isSlotOutlet(u.children[0])
              ? u.children[0]
              : null;
        if (
          (r
            ? ((e = r.codegenNode), a && p && injectProp(e, p, h))
            : n
              ? (e = createVNodeCall(
                  h,
                  f(FRAGMENT),
              ...
              : ((e = t[0].codegenNode),
                a && p && injectProp(e, p, h),
                e.isBlock !== !d &&
                  (e.isBlock
                    ? (m(OPEN_BLOCK),
                      m(getVNodeBlockHelper(h.inSSR, e.isComponent)))
                    : m(getVNodeHelper(h.inSSR, e.isComponent))),
                (e.isBlock = !d),
                e.isBlock
                  ? (f(OPEN_BLOCK),
                    f(getVNodeBlockHelper(h.inSSR, e.isComponent)))
                  : f(getVNodeHelper(h.inSSR, e.isComponent))),
          l)
        ) {
          ...
          (o.body = createBlockStatement([
            ...
            createCompoundExpression([
              "if (_cached",
              ...(c ? [" && _cached.key === ", c] : []),
              ` && ${h.helperString(IS_MEMO_SAME)}(_cached, _memo)) return _cached`,
            ]),
            ...
            i.arguments.push(
              ...
              createSimpleExpression(String(h.cached++)),
            );
        } else
          i.arguments.push(
...
function finalizeForParseResult(e, t) {
  e.finalized ||
    (validateBrowserExpression(e.source, t),
    e.key && validateBrowserExpression(e.key, t, !0),
    e.index && validateBrowserExpression(e.index, t, !0),
    e.value && validateBrowserExpression(e.value, t, !0),
    (e.finalized = !0));
}
...
const defaultFallback = createSimpleExpression("undefined", !1),
  ...
  buildClientSlotFn = (e, t, n, r) =>
    createFunctionExpression(e, n, !1, !0, n.length ? n[0].loc : r);
  ...
  for (let n = 0; n < s.length; n++) {
    ...
    if (isTemplateNode(m) && (t = findDir(m, "slot", !0))) {
      ...
      var { children: g, loc: v } = m,
        { arg: y = createSimpleExpression("default", !0), exp: S, loc: E } = t;
      let e;
      ...
      if ((g = findDir(m, "if")))
        ...
        g = C.forParseResult;
        g
          ? (finalizeForParseResult(g, r),
            a.push(
              createCallExpression(r.helper(RENDER_LIST), [
                g.source,
                createFunctionExpression(
                  createForLoopParams(g),
                  buildDynamicSlot(y, S),
                  !0,
                ),
              ]),
            ))
          : r.onError(createCompilerError(32, C.loc));
      } else {
        if (e) {
          if (h.has(e)) {
            r.onError(createCompilerError(38, E));
            continue;
          }
          h.add(e), "default" === e && (d = !0);
        }
        i.push(createObjectProperty(y, S));
      }
    } else 3 !== m.type && u.push(m);
  }
  c ||
    ((t = (e, t) => {
      return createObjectProperty("default", o(e, void 0, t, n));
    }),
    p
      ? u.length &&
        u.some((e) => isNonWhitespaceContent(e)) &&
        (d
          ? r.onError(createCompilerError(39, u[0].loc))
          : i.push(t(void 0, u)))
      : i.push(t(void 0, s)));
  var b = l ? 2 : hasForwardedSlots(e.children) ? 3 : 1;
  let T = createObjectExpression(
    i.concat(
      createObjectProperty(
        "_",
        createSimpleExpression(b + ` /* ${slotFlagsText[b]} */`, !1),
      ),
    ),
    n,
  );
...
const directiveImportMap = new WeakMap(),
  transformElement = (f, m) =>
    function () {
      if (
        1 === (f = m.currentNode).type &&
        (0 === f.tagType || 1 === f.tagType)
      ) {
        var { tag: l, props: c } = f,
          p = 1 === f.tagType,
          d = p ? resolveComponentType(f, m) : `"${l}"`,
          u = isObject(d) && d.callee === RESOLVE_DYNAMIC_COMPONENT;
        let e,
          t,
          n,
          r = 0,
        ...
        if (0 < c.length) {
          var l = buildProps(f, m, void 0, p, u);
          (e = l.props), (r = l.patchFlag), (s = l.dynamicPropNames);
          const h = l.directives;
          (i =
            h && h.length
              ? createArrayExpression(h.map((e) => buildDirectiveArgs(e, m)))
              : void 0),
        ...
        0 < f.children.length &&
          ...
          p && d !== TELEPORT && d !== KEEP_ALIVE
            ? (({ slots: c, hasDynamicSlots: u } = buildSlots(f, m)),
              (t = c),
              u && (r |= 1024))
            : (t =
                1 === f.children.length && d !== TELEPORT
                  ? ((u = 5 === (c = (l = f.children[0]).type) || 8 === c) &&
                      0 === getConstantType(l, m) &&
                      (r |= 1),
                    u || 2 === c ? l : f.children)
                  : f.children)),
          0 !== r &&
...
function buildProps(t, o, n = t.props, r, F, s = !1) {
  ...
  for (let e = 0; e < n.length; e++) {
    var C = n[e];
    if (6 === C.type) {
      const { loc: H, name: R, nameLoc: B, value: w } = C;
      "ref" === R &&
        ((f = !0),
        0 < o.scopes.vFor &&
          l.push(
        ...
        ("is" === R &&
          (isComponentTag(i) || (w && w.content.startsWith("vue:")))) ||
          l.push(
            createObjectProperty(
              createSimpleExpression(R, !0, B),
              createSimpleExpression(w ? w.content : "", !0, w ? w.loc : H),
            ),
          );
    } else {
      const { name: O, arg: A, exp: k, loc: N, modifiers: j } = C;
      var b = "bind" === O,
        T = "on" === O;
      if ("slot" === O) r || o.onError(createCompilerError(40, N));
      else if (
        "once" !== O &&
        "memo" !== O &&
        !(
          "is" === O ||
          (b && isStaticArgOf(A, "is") && isComponentTag(i)) ||
          (T && s)
        )
      )
        if (
          (((b && isStaticArgOf(A, "key")) ||
            (T && d && isStaticArgOf(A, "vue:before-update"))) &&
            (u = !0),
          b &&
            isStaticArgOf(A, "ref") &&
            0 < o.scopes.vFor &&
          ...
          b && j.includes("prop") && (h |= 32);
          const I = o.directiveTransforms[O];
          if (I) {
            const { props: P, needRuntime: M } = I(C, t, o);
            s || P.forEach($),
              T && A && !isStaticExp(A)
                ? E(createObjectExpression(P, a))
                : l.push(...P),
              M && (p.push(C), isSymbol(M) && directiveImportMap.set(C, M));
          } else isBuiltInDirective(O) || (p.push(C), d && (u = !0));
        } else
          (y = !0),
            k
              ? b
                ...
                : E({
                    ...
                    arguments: r ? [k] : [k, "true"],
                  })
              : o.onError(createCompilerError(b ? 34 : 35, N));
    }
  }
  let x = void 0;
  if (
      ...
      ? (E(),
        (x =
          1 < c.length
            ...
            : c[0]))
      : l.length && (x = createObjectExpression(dedupeProperties(l), a)),
    y
      ? (h |= 16)
      : (m && !r && (h |= 2),
        g && !r && (h |= 4),
        S.length && (h |= 8),
        v && (h |= 32)),
    u || (0 !== h && 32 !== h) || !(f || L || 0 < p.length) || (h |= 512),
    !o.inSSR && x)
  )
    switch (x.type) {
      case 15:
        let t = -1,
          n = -1,
          r = !1;
        for (let e = 0; e < x.properties.length; e++) {
          var _ = x.properties[e].key;
          isStaticExp(_)
            ? "class" === _.content
              ? (t = e)
              : "style" === _.content && (n = e)
        ...
        const e = x.properties[t],
          V = x.properties[n];
        r
          ? (x = createCallExpression(o.helper(NORMALIZE_PROPS), [x]))
          : (e &&
              !isStaticExp(e.value) &&
              (e.value = createCallExpression(o.helper(NORMALIZE_CLASS), [
                e.value,
              ])),
            V &&
              (g ||
      ...
      case 14:
        break;
      default:
        x = createCallExpression(o.helper(NORMALIZE_PROPS), [
          createCallExpression(o.helper(GUARD_REACTIVE_PROPS), [x]),
        ]);
    }
  return {
    props: x,
    ...
    6 === l.type
      ? l.value &&
        ("name" === l.name
          ...
          : ((l.name = camelize(l.name)), o.push(l)))
      : "bind" === l.name && isStaticArgOf(l.arg, "name")
        ? l.exp
          ? (n = l.exp)
          : l.arg &&
            4 === l.arg.type &&
            ((s = camelize(l.arg.content)),
            (n = l.exp = createSimpleExpression(s, !1, l.arg.loc)))
        : ("bind" === l.name &&
            l.arg &&
            isStaticExp(l.arg) &&
            (l.arg.content = camelize(l.arg.content)),
          o.push(l));
  }
  var i, a;
  return (
    0 < o.length &&
      (({ props: i, directives: a } = buildProps(t, e, o, !1, !1)),
      (r = i),
      a.length && e.onError(createCompilerError(36, a[0].loc))),
...
const fnExpRE =
  ...
  transformOn$1 = (e, t, n, r) => {
    ...
    if (4 === i.type)
      if (i.isStatic) {
        let e = i.content;
        e.startsWith("vnode") && n.onError(createCompilerError(51, i.loc)),
  ...
  transformBind = (e, t, n) => {
    ...
    if (!(i = i && 4 === i.type && !i.content.trim() ? void 0 : i)) {
      if (4 !== s.type || !s.isStatic)
        return (
          n.onError(createCompilerError(52, s.loc)),
          {
            props: [createObjectProperty(s, createSimpleExpression("", !0, o))],
          }
        );
      var a = camelize(s.content);
      i = e.exp = createSimpleExpression(a, !1, s.loc);
    }
    return (
      4 !== s.type
      ...
      r.includes("camel") &&
        (4 === s.type
          ? s.isStatic
            ? (s.content = camelize(s.content))
            : (s.content = `${n.helperString(CAMELIZE)}(${s.content})`)
          : (s.children.unshift(n.helperString(CAMELIZE) + "("),
            s.children.push(")"))),
      n.inSSR ||
        (r.includes("prop") && injectPrefix(s, "."),
        r.includes("attr") && injectPrefix(s, "^")),
      { props: [createObjectProperty(s, i)] }
    );
  },
  injectPrefix = (e, t) => {
    4 === e.type
  ...
  transformOnce = (e, t) => {
    if (
      1 === e.type &&
      findDir(e, "once", !0) &&
      !(seen$1.has(e) || t.inVOnce || t.inSSR)
    )
      return (
        seen$1.add(e),
        (t.inVOnce = !0),
      ...
      if (r && !seen.has(t))
        return (
          ...
          () => {
            ...
            e &&
              13 === e.type &&
              (1 !== t.tagType && convertToBlock(e, n),
...
function baseCompile(e, t = {}) {
  ...
  var r = "module" === t.mode,
    r =
      ...
      extend({}, t, { prefixIdentifiers: !1 })),
    e = isString(e) ? baseParse(e, r) : e,
    [o, s] = getBaseTransformPreset();
  return (
    transform(
      e,
      extend({}, r, {
        nodeTransforms: [...o, ...(t.nodeTransforms || [])],
        directiveTransforms: extend({}, s, t.directiveTransforms || {}),
      }),
    ),
    generate(e, r)
  );
...
const DOMErrorMessages = {
  ...
  transformVText = (e, t, n) => {
    var { exp: e, loc: r } = e;
    return (
      e || n.onError(createDOMCompilerError(55, r)),
      t.children.length &&
        (n.onError(createDOMCompilerError(56, r)), (t.children.length = 0)),
      {
        props: [
          createObjectProperty(
  ...
  transformModel = (n, r, o) => {
    ...
    function i() {
      var e = findDir(r, "bind");
      e &&
        isStaticArgOf(e.arg, "value") &&
        o.onError(createDOMCompilerError(60, e.loc));
    }
    n.arg && o.onError(createDOMCompilerError(58, n.arg.loc));
    var a = r["tag"],
          ...
          if (7 === l.type) e = V_MODEL_DYNAMIC;
            ...
            switch (l.value.content) {
              ...
              case "checkbox":
                ...
                break;
              case "file":
                (t = !0), o.onError(createDOMCompilerError(59, n.loc));
                break;
              default:
                i();
            }
    ...
    } else o.onError(createDOMCompilerError(57, n.loc));
    return (
  ...
  transformShow = (e, t, n) => {
    var { exp: e, loc: r } = e;
    return (
      e || n.onError(createDOMCompilerError(61, r)),
...
const ignoreSideEffectTags = (e, t) => {
    1 !== e.type ||
      ...
      (t.onError(createDOMCompilerError(63, e.loc)), t.removeNode());
  },
...
function getCache(e) {
  let t = compileCache.get(null != e ? e : EMPTY_OBJ);
  return (
    t ||
      ((t = Object.create(null)),
      compileCache.set(null != e ? e : EMPTY_OBJ, t)),
    t
  );
}
function compileToFunction(n, e) {
  ...
  "#" === n[0] &&
    ...
    (n = o ? o.innerHTML : ""));
  const s = extend({ hoistStatic: !0, onError: i, onWarn: (e) => i(e, !0) }, e);
  s.isCustomElement ||
...
` +
  ...
  const a = new Function("Vue", o)(runtimeDom);
